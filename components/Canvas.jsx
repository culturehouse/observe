		...
		const response = fetch(`/api/create_instance/${router.query.eventId}`, {
			...
			const res2 = fetch("/api/create_instance/new_instance", {
				...
				if (r.created) {
					...
					router.push(`/instances?id=${router.query.eventId}&eventId=${router.query.eventId}&eventName=${router.query.eventName}&projId=${router.query.projId}&projName=${router.query.projName}`)
				} else {
		...
		<div className={styles.outer}>
			<div className={styles.content}>
				...
				<div className={styles.inputFields}>
					...
					></textarea>
					{sending ? 
						<button onClick={onCanvasSubmit} className={styles.sendButton} disabled>
