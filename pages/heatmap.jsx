...
export default function Heatmap() {
  ...
  const pdfGenerate = async () => {
    ...
    const backgroundImageNode = clonedSvg.querySelector(
      'image[alt="background sketch"]'
    );
    ...
    const [backgroundImageData, canvasImageData] = await Promise.all([
    ...
    if (includeInfo) {
      ...
      doc.text(
        ...
        215.41,
        "Date created: " +
          (heatmapInfo ? heatmapInfo["dateCreated"] : "undefined")
      );
      doc.text(
        17.22,
        224.4,
        "Date modified: " +
          (heatmapInfo ? heatmapInfo["dateModified"] : "undefined")
      );
      doc.text(
        17.22,
        233.39,
      ...
      doc.text(
        ...
        "Filters applied: " +
          (heatmapInfo["filterQuery"]
            ? heatmapInfo["filterQuery"]
                .map((filter) => filterProcessing(filter))
                .join(". ")
  ...
  return (
    <div className={styles.border}>
      <Head>
        <title>View and edit heatmap | Observe</title>
      </Head>
      {showInstances && (
              ...
              <div className={styles.heatInfoBox}>
                <div className={styles.heatInfo}>
                  <p>
                    ...
                    {heatmapInfo["dateCreated"]
                      ? dateModifier(heatmapInfo["dateCreated"])
                      : "undefined"}{" "}
                  </p>{" "}
                  <br></br>
                  <p>
                    <span className={styles.infoHeaders}>Date modified: </span>
                    {heatmapInfo["dateModified"]
                      ? dateModifier(heatmapInfo["dateModified"])
                      : "undefined"}{" "}
                  </p>{" "}
                  <br></br>
                  <p>
              ...
              <div className={styles.noteBox}>
                <div className={styles.note}>
                  <textarea
                    ...
                    cols={50}
                    placeholder={
                      'Click here to take notes - don\'t forget to hit "save" afterwards!'
                    }
                  ></textarea>
                </div>
              </div>
